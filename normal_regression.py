...
def gen_model(dataset, seed, path, output_device, extra_val=None, base_model = vanilla_nn, dataset_path='data/UCI_Datasets', base_model_args=None, train_val_data = None):
    #seed = 0
    ...
    if train_val_data is None:
        ...
        X, X_val, Y, Y_val = train_val_data
    ...
    our_model = base_model(X.shape[1], **base_model_args).to(output_device)
